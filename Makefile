#############################################################################
# Makefile for building: MooDooGUI.app/Contents/MacOS/MooDooGUI
# Generated by qmake (3.1) (Qt 6.9.1)
# Project:  MooDooGUI.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile MooDooGUI.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = MooDooGUI1.0.0
DISTDIR = /Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/.tmp/MooDooGUI1.0.0
...
EXPORT__QMAKE_STASH_ = /Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/MooDooGUI.pro
...
MooDooGUI.app/Contents/MacOS/MooDooGUI:  $(OBJECTS)  
	@test -d MooDooGUI.app/Contents/MacOS/ || mkdir -p MooDooGUI.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: MooDooGUI.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.1/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile MooDooGUI.pro
...
MooDooGUI.app/Contents/PkgInfo: 
	@test -d MooDooGUI.app/Contents || mkdir -p MooDooGUI.app/Contents
	@$(DEL_FILE) MooDooGUI.app/Contents/PkgInfo
	@echo "APPL????" > MooDooGUI.app/Contents/PkgInfo
MooDooGUI.app/Contents/Info.plist: 
	@test -d MooDooGUI.app/Contents || mkdir -p MooDooGUI.app/Contents
	@$(DEL_FILE) MooDooGUI.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.MooDooGUI,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.MooDooGUI,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,MooDooGUI,g" -e "s,@LIBRARY@,MooDooGUI,g" -e "s,\$${EXECUTABLE_NAME},MooDooGUI,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >MooDooGUI.app/Contents/Info.plist

all: Makefile \
		MooDooGUI.app/Contents/PkgInfo \
		MooDooGUI.app/Contents/Info.plist MooDooGUI.app/Contents/MacOS/MooDooGUI
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/MainWindow.h src/AddTaskDialog.h src/MoodEntryDialog.h src/MoodHistoryPage.h src/TaskListPage.h $(DISTDIR)/
	$(COPY_FILE) --parents src/main_gui.cpp src/MainWindow.cpp src/Storage.cpp src/AddTaskDialog.cpp src/MoodEntryDialog.cpp src/MoodHistoryPage.cpp src/TaskListPage.cpp $(DISTDIR)/
...
compiler_moc_header_make_all: moc_MainWindow.cpp moc_AddTaskDialog.cpp moc_MoodEntryDialog.cpp moc_MoodHistoryPage.cpp moc_TaskListPage.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_MainWindow.cpp moc_AddTaskDialog.cpp moc_MoodEntryDialog.cpp moc_MoodHistoryPage.cpp moc_TaskListPage.cpp
...
moc_MoodHistoryPage.cpp: src/MoodHistoryPage.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QVBoxLayout \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qboxlayout.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo -I/Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/src -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/opt/homebrew/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/14.0.3/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib src/MoodHistoryPage.h -o moc_MoodHistoryPage.cpp
...
moc_TaskListPage.cpp: src/TaskListPage.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include /Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/moc_predefs.h -I/opt/homebrew/share/qt/mkspecs/macx-clang -I/Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo -I/Users/joshareshua/Documents/Personal_Projects/MooDoo2/MooDoo/src -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/opt/homebrew/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/14.0.3/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib src/TaskListPage.h -o moc_TaskListPage.cpp
...
main_gui.o: src/main_gui.cpp /opt/homebrew/lib/QtWidgets.framework/Headers/QApplication \
...
MoodHistoryPage.o: src/MoodHistoryPage.cpp src/MoodHistoryPage.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QVBoxLayout \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qboxlayout.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QDateTime \
		/opt/homebrew/lib/QtCore.framework/Headers/qdatetime.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o MoodHistoryPage.o src/MoodHistoryPage.cpp
...
TaskListPage.o: src/TaskListPage.cpp src/TaskListPage.h \
		...
		/opt/homebrew/lib/QtWidgets.framework/Headers/QMessageBox \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qmessagebox.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TaskListPage.o src/TaskListPage.cpp
...
moc_MoodHistoryPage.o: moc_MoodHistoryPage.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_MoodHistoryPage.o moc_MoodHistoryPage.cpp
